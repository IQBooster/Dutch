...
namespace Mod_Hub_Base::UserInterface
{
	...
	public:
		...
		float m_HeaderTextSize = 1.30f;
		Font m_HeaderFont = Font::HouseScript;
		Color m_HeaderBackgroundColor{ 255, 17, 17, 255 };
		...
		Color m_SubmenuBarTextColor{ 255, 17, 17, 255 };

		// Options
		float m_OptionHeight = 0.036f;
		float m_OptionTextSize = 0.33f;
		...
		Color m_OptionSelectedBackgroundColor{ 255, 17, 17, 255 };
		Color m_OptionUnselectedBackgroundColor{ 12, 12, 12, 240 };
		...
		// Footer
		float m_FooterHeight = 0.00f;
		float m_FooterSpriteSize = 0.00f;
		...
		Color m_OverlayColor{ 15,15,15,255 };
		Color m_OverlayTextColor{ 255, 255, 255, 255 };
		Color m_OverlayLineColor{ 67,181,238,255 };
	public:
